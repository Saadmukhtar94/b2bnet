  ...
  <div className="row g-4">
    ...
    <div className="col-12 col-lg-6">
      ...
      <div className="business-detail-section bg-white rounded p-4 mb-3">
        ...
        <p>
          Revolutionising Your Digital Experience - Innovative IT Solutions for
          Businesses and Individuals. We specialize in creating custom software
          solutions that help businesses streamline their operations and improve
          efficiency.
        </p>
        <p>
          Our team of experienced developers and IT professionals are dedicated
          to delivering high-quality solutions that meet the unique needs of
          each client. We work closely with our clients to understand their
          requirements and provide tailored solutions that exceed their
          expectations.
        </p>
      </div>
      {/* Services Section */}
        ...
        <div className="service-list">
          <div className="service-item mb-3">
            ...
            <p className="ms-4 mb-0 text-muted">
              ...
              including web applications, mobile apps, and enterprise solutions.
            </p>
          </div>
          <div className="service-item mb-3">
            <div className="d-flex align-items-center mb-2">
            ...
            <p className="ms-4 mb-0 text-muted">
              Expert advice on technology strategy, digital transformation, and
          ...
          <div className="service-item mb-3">
            ...
            <p className="ms-4 mb-0 text-muted">
              User-centered design services to create intuitive and engaging
              digital experiences.
            </p>
          </div>
          <div className="service-item">
            ...
            <p className="ms-4 mb-0 text-muted">
              Ongoing technical support and maintenance services to ensure your
          ...
          <div className="col-md-6 mb-3">
            <div className="contact-info">
              ...
              <div className="mb-2">
                ...
                <a href="tel:+442071234567" className="text-decoration-none">
                  +44 20 7123 4567
                </a>
              </div>
              <div>
            ...
            <div className="d-flex">
              ...
              <div>
                ...
                <div className="text-muted small">
                  IT services and software development for small and medium
                  businesses
                </div>
          ...
          <div className="side-business">
            <div className="d-flex">
              ...
              <div>
                ...
                <div className="text-muted small">
                  Web and mobile app development with focus on user experience
                </div>
                <div className="d-flex align-items-center mt-1">
                  <i
                    className="fas fa-map-marker-alt text-muted me-1"
          ...
          <div className="side-business">
            <div className="d-flex">
              ...
              <div>
                ...
                <div className="text-muted small">
                  Cloud infrastructure and migration services for businesses
                </div>
                <div className="d-flex align-items-center mt-1">
                  <i
                    className="fas fa-map-marker-alt text-muted me-1"
