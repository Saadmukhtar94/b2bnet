      ...
      <div className="feedback-form bg-white rounded p-4">
        ...
        <div className="feedback-intro mb-4">
          <p>
            ...
            report any issues you've encountered while using B2BNet. Your
            feedback helps us improve our platform.
          </p>
        </div>
        <form id="feedbackForm">
            ...
            <div className="d-flex flex-wrap gap-2">
              <div className="form-check">
                <input
                  ...
                  defaultChecked=""
                />
                <label className="form-check-label" htmlFor="suggestionType">
                  Suggestion
                </label>
              </div>
              <div className="form-check">
              ...
              <div className="form-check">
                ...
                />
                <label className="form-check-label" htmlFor="complimentType">
                  Compliment
                </label>
              </div>
              <div className="form-check">
          ...
          <div className="mb-3">
            ...
            <select className="form-select" id="featureArea" required defaultValue="">
  ...
  <option value="other">Other</option>
          ...
          <div className="mb-4">
            ...
            <div className="input-group">
              ...
              />
              <label className="input-group-text" htmlFor="feedbackAttachment">
                Upload
              </label>
            </div>
        ...
        <div id="feedbackSuccess" className="mt-4 text-center d-none">
          ...
          <p className="mb-0">
            If you've requested to be contacted, a member of our team will get
            back to you soon.
          </p>
        </div>
      </div>
        ...
        <div className="card-body">
          ...
          <div className="accordion" id="faqAccordion">
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  ...
                  improve B2BNet. We prioritize changes based on user feedback
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  If you've checked the option to be contacted, we'll respond to
                  your feedback within 2-3 business days. For urgent issues,
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Select "Bug/Issue" as your feedback type and provide as much
                  detail as possible, including steps to reproduce the issue,
                  your device, browser, and screenshots if available.
                </div>
              </div>
            </div>
          </div>
