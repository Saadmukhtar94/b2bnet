...
//             ></div>
//           </div>
//           <small className="text-muted">Password strength: <span id="strength-text">{strengthText}</span></small>
//         </div>
//       </div>
...
export default function RegisterForm() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'password_confirmation') {
      e.target.setCustomValidity(value !== formData.password ? 'Passwords do not match' : '');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const apiFormData = { ...formData, c_password: formData.password_confirmation };
      await register(apiFormData);
  ...
  return (
    <form className="auth-form" onSubmit={handleSubmit}>
      ...
      {/* Improved input fields with Bootstrap styling */}
      <div className="row mb-3">
        <div className="col-md-6">
      ...
      <div className="mb-3">
        ...
        <div className="progress mt-2" style={{ height: '5px' }}>
          <div className={`progress-bar ${strengthClass}`} style={{ width: `${passwordStrength}%` }}></div>
        </div>
        <small>Password strength: {strengthText}</small>
      </div>
      ...
      <div className="mb-3 form-check">
        <input className="form-check-input" type="checkbox" checked={termsAccepted} onChange={(e) => setTermsAccepted(e.target.checked)} required />
        <label className="form-check-label">I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a></label>
      </div>
      ...
      <div className="text-center mt-3">
        ...
        <div className="d-flex justify-content-center gap-2 mt-2">
          <button type="button" className="btn btn-outline-secondary"><i className="fab fa-google"></i></button>
          <button type="button" className="btn btn-outline-secondary"><i className="fab fa-facebook-f"></i></button>
          <button type="button" className="btn btn-outline-secondary"><i className="fab fa-linkedin-in"></i></button>
        </div>
      </div>
    </form>
  );
