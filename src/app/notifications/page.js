            ...
            <div className="notification-list">
                ...
                <div className="notification-content">
                  ...
                  <div className="notification-details">
                    <div className="notification-text">
                      <strong>Tekgenie</strong> has invited you to their
                      upcoming event 

                                     
                             
                      <strong>&#34;Adobe Illustrator Beginner Tutorial&#34;</strong> on
                      September 17, 2024.
                    </div>
              ...
              <div className="notification-item">
                <div className="notification-content">
                  ...
                  <div className="notification-details">
                    <div className="notification-text">
                      <strong>London Built Environment</strong> has mentioned
                      you in a post about
                      ...
                      <strong>&#34;Networking Breakfast&#34;</strong>.
                    </div>
              ...
              <div className="notification-item">
                <div className="notification-content">
                  ...
                  <div className="notification-details">
                    <div className="notification-text">
                      Welcome to B2BNet! Complete your profile to connect with
                      other businesses.
                    </div>
