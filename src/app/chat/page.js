          ...
          <div className="chat-list">
            ...
            <div className="chat-item active">
              ...
              <div className="chat-details">
                ...
                <div className="chat-last-message">
                  Thanks for reaching out! We'd be happy to discuss potential
            ...
            <div className="chat-item unread">
              ...
              <div className="chat-details">
                ...
                <div className="chat-last-message">
                  Hi there! I saw your business profile and I'm interested in
                  your services.
                </div>
                <div className="chat-meta">
            ...
            <div className="chat-item">
              ...
              <div className="chat-details">
                ...
                <div className="chat-last-message">
                  The design mockups are ready for review. I've attached them to
                  this message.
                </div>
                <div className="chat-meta">
          ...
          <div className="chat-messages">
            ...
            <div className="message received">
              <div className="message-avatar">
                <img src="/images/dp.png" alt="New West End Company" />
              </div>
              <div className="message-content">
                <div className="message-bubble">
                  <div className="message-text">
                    Hello! Thank you for connecting with us. How can we help you
                    today?
                  </div>
                </div>
            ...
            <div className="message received">
              ...
              <div className="message-content">
                <div className="message-bubble">
                  <div className="message-text">
                    Absolutely! We have several networking events coming up.
                    Here's our events calendar for the next quarter:
                  </div>
              ...
              <div className="message-content">
                <div className="message-bubble">
                  <div className="message-text">
                    ...
                    Landmark Hotel. It's specifically for businesses in the tech
                    and retail sectors. Would you be interested in attending?
                  </div>
                </div>
                <div className="message-info">
              ...
              <div className="message-content">
                <div className="message-bubble">
                  <div className="message-text">
                    ...
                    attending. Are there any opportunities for businesses to
                    present or showcase their services at the event?
                  </div>
                </div>
                <div className="message-info">
            ...
            <div className="message received">
              ...
              <div className="message-content">
                <div className="message-bubble">
                  <div className="message-text">
                    Thanks for reaching out! We'd be happy to discuss potential
                    collaboration opportunities. We do have exhibition spaces
                    available for businesses to showcase their services. The
                    standard booth is £500, but we also have premium spots
                    available.
                  </div>
                </div>
                <div className="message-info">
        ...
        <div className="chat-info">
          ...
          <div className="chat-info-content">
            <div className="text-center mb-4">
              ...
              <div className="text-muted">Business Improvement District</div>
            ...
            <div className="chat-info-section">
              ...
              <p className="section-content">
                New West End Company is a business improvement district for
                London's West End. We represent over 600 businesses in the area,
                working to promote and enhance the commercial environment.
              </p>
            </div>
            <div className="chat-info-section">
            ...
            <div className="chat-info-section">
              ...
              <div className="shared-file">
                ...
                <div className="file-info">
                  <div className="file-name">Partnership_Proposal.docx</div>
            ...
            <div className="chat-info-section">
              ...
              <div className="action-buttons">
                ...
                <button className="btn btn-outline-secondary btn-sm">
                  <i className="fas fa-bell-slash me-1" /> Mute Notifications
                </button>
                <button className="btn btn-outline-secondary btn-sm">
          ...
          <div className="suggested-connection">
            <div className="d-flex align-items-center mb-2">
              ...
              <div>
                ...
                <div className="text-muted small">Tech &amp; Software</div>
              </div>
            </div>
